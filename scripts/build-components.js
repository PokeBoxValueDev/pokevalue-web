...
${resultHtml}
    ...
    <div id="kofi-widget-container" class="text-center my-6 max-w-xl mx-auto px-4 flex justify-center min-h-[42px]">
        <script type='text/javascript' src='https://storage.ko-fi.com/cdn/widget/Widget_2.js' onload="if(typeof kofiwidget2 !== 'undefined'){ kofiwidget2.init('Apoyar proyecto', '#72a4f2', 'E1U623YPMD'); kofiwidget2.draw(); }"></script>
        <script type='text/javascript'>
            window.addEventListener('DOMContentLoaded', () => {
                if (typeof kofiwidget2 !== 'undefined' && !document.querySelector('.kofi-button')) {
                    try { kofiwidget2.init('Apoyar proyecto', '#72a4f2', 'E1U623YPMD'); kofiwidget2.draw(); } catch(e) {}
                }
            });
        </script>
    </div>
