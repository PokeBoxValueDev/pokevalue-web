export default {
    ...
    btnCloseModal: "Close",
    btnBackToCalculator: "← Back to Calculator",
    resultVerdictTitle: "Result",
    storySubtitle: "POKÉMON GO BOX VALUE CALCULATOR",
    moreItemsCount: "+ {count} more items...",
    removeItem: "Remove",
    decrementQty: "Decrease quantity of",
    incrementQty: "Increase quantity of",
    quantityOf: "Quantity of",
    defaultItem: "Item",
    shareBoxSummaryTitle: "PokeBoxValue - Box Calculation Result:",
    shareStatusLabel: "Status:",
    shareNotSpecified: "Not specified",
    shareTitlePost: "PokeBoxValue - Box Value Calculator",
    tableItemPremiumPass: "Premium Battle Pass",
    tableItemRemotePass: "Remote Raid Pass",
    tableItemSuperIncubator: "Super Incubator",
    tableItemIncubator: "Egg Incubator",
    tableItemStarPieceEgg: "Star Piece / Lucky Egg",
    tableItemPoffin: "Poffin",
    errorLoadingItems: "Error loading store items.",
    btnRetry: "Retry",
