export default {
    ...
    privacyBody3: "Los proveedores de terceros, incluido Google, utilizan cookies para publicar anuncios basándose en las visitas anteriores de un usuario a este sitio web u otros sitios web. El uso de cookies de publicidad permite a Google y a sus socios publicar anuncios basados en la visita a este u otros sitios en Internet. Puedes inhabilitar la publicidad personalizada visitando la <a href='https://myadcenter.google.com/' target='_blank' class='text-indigo-600 dark:text-indigo-400 hover:underline'>Configuración de anuncios de Google</a> o la de terceros en <a href='https://www.aboutads.info' target='_blank' class='text-indigo-600 dark:text-indigo-400 hover:underline'>www.aboutads.info</a>.",
