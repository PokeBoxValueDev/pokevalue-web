...
test('Icon y Manifest - Verificación de configuración y assets', (t) => {
    ...
    // 1. Verificar existencia de favicon.svg y favicon-light.svg válidos
    assert.strictEqual(fs.existsSync(faviconPath), true, 'favicon.svg debe existir en la raíz');
    assert.strictEqual(fs.existsSync(path.join(rootDir, 'favicon-light.svg')), true, 'favicon-light.svg debe existir en la raíz');
